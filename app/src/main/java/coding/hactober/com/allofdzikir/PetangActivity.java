...
public class PetangActivity extends AppCompatActivity {

    private AdapterList adapterDzikir;
    RecyclerView rvmain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idDzikirsore = getIntent().getStringExtra("KEY_SORE");
        ...
        adapterDzikir = new AdapterList(arrayList);
        rvmain.setAdapter(adapterDzikir);
    }

    private void setdatapagi() {
        int count = 0;
        for (String id : menuItemsore) {
            arrayList.add(new ModelAdapter(id, menuLagisore[count]));
            count++;
        }
    }
